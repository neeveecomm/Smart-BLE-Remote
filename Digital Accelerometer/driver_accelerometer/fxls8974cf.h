...
#define fxls8974cf_COMPLEMENT        0xfc00
...
uint8_t sensor_comm_write(const struct i2c_dt_spec *dev_i2c, uint16_t offset, uint16_t size, uint8_t *pWritebuffer)
{
	uint8_t buf[size + 1];
...
uint8_t sensor_comm_read(const struct i2c_dt_spec *dev_i2c, uint16_t offset, uint16_t size, uint8_t *pReadbuffer)
{
