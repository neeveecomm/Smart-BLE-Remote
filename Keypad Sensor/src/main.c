...
static struct i2c_dt_spec sx_i2c = I2C_DT_SPEC_GET(DT_NODELABEL(sx1509b));

static struct gpio_dt_spec sx_gpio = GPIO_DT_SPEC_GET_BY_IDX(DT_NODELABEL(sx1509b),nint_gpios,0);
